...
const OSBootPreloader = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black font-mono text-purple-500 flex flex-col justify-center items-center z-50 overflow-hidden">
  ...
  <div className="bg-black bg-opacity-70 p-6 rounded-lg shadow-lg">
    <div className="mb-4 h-2 bg-purple-900 rounded-full overflow-hidden">
      <div
    ...
    {bootSteps.map((step, index) => (
      <div key={index} className="mb-2 overflow-hidden whitespace-nowrap">
        <span className="text-purple-600">[SYSTEM]</span> {step}
      </div>
    ))}
    ...
    {!loading && (
      <div className="mt-8 text-center">
        ...
        <div className="text-sm flex items-center justify-center gap-2">
          <span className="h-2 w-2 bg-purple-500 rounded-full cursor-blink inline-block"></span>
